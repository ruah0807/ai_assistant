...
def run_with_tools(ass_id, thread):
    ...
    run = client.beta.threads.runs.create(
        ...
        문서들을 참고하여 해당된다 판단되는 '유사군코드'를 찾아 JSON형식으로 나열하세요.
        문서 목록은 총 267개이며 각 유사코드가 1000개씩 배치 되어있습니다.
        ...
        응답 형식에는 이유와 함께 반드시 **JSON 형식**의 답변을 포함합니다.:
        ...
        - 자신의 답이 문서 내에서 찾은 것이 맞는지 한번 더 확인한 후 대답합니다.
